...
% writematrix(m_all, 'm_all.csv')
% writematrix(G_all, 'G_all.csv')
% writematrix(simPra, 'simPra.csv')
% writematrix(simPrb, 'simPrb.csv')
% writematrix(simPrc, 'simPrc.csv')
% writematrix(simPrd, 'simPrd.csv')
